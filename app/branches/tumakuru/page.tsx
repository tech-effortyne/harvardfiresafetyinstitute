...
export const metadata: Metadata = {
    title: PAGE_METADATA.branches.tumakuru.title,
    description: PAGE_METADATA.branches.tumakuru.description,
    keywords: PAGE_METADATA.branches.tumakuru.keywords,
    alternates: {
        canonical: "/branches/tumakuru",
    },
};
...
export default function TumakuruBranchPage() {
    return (
        <>
            {/* 1. Hero Section */}
            <section className="bg-gradient-to-r from-[#7A1E2B] to-[#5a1620] py-12 md:py-20 relative overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/Harvard_images/Training/Training_1.webp"
                        alt="Harvard Institute Tumakuru Branch"
                        fill
                ...
                <div className="container-custom relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <p className="text-white/80 text-lg leading-relaxed">
                            Professional fire and safety training at Kunigal Road, Tumakuru.
                    ...
                    <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                        ...
                        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                            <div className="px-6 py-4 border-b-2 border-[#7A1E2B] bg-[#7A1E2B]/5 flex items-center gap-2">
                                ...
                                <h3 className="font-semibold text-[#7A1E2B] tracking-wide uppercase text-sm">Industries</h3>
                            </div>
                        ...
                        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                            <div className="px-6 py-4 border-b-2 border-[#F57C00] bg-[#F57C00]/5 flex items-center gap-2">
                                ...
                                <h3 className="font-semibold text-[#F57C00] tracking-wide uppercase text-sm">Designations</h3>
                            </div>
                            <ul className="divide-y divide-gray-100">
            ...
            <section className="py-12 bg-gray-50">
                <div className="container-custom">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-sm text-[#2B2B2B]/60">Get in touch with our Tumakuru team</p>
                    </div>
                        ...
                        <div className="flex items-start gap-4 px-6 py-5 border-l-4 border-[#7A1E2B]">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-[#2B2B2B]/70 leading-relaxed">
                                    Beside Apollo Pharmacy, Opp. Hemavathi Canal Division,<br />
                                    Near Banashankari Temple, Kunigal Road,<br />
                                    Tumakuru – 572101
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4 px-6 py-5 border-l-4 border-[#F57C00]">
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-x-6 gap-y-1">
                                    {["70191 27564", "63620 21692"].map((phone) => (
                                        <a
                                            key={phone}
                                            href={`tel:${phone.replace(/\s/g, "")}`}
                                            title={`Call Tumakuru branch at ${phone}`}
                        ...
                        <div className="flex items-start gap-4 px-6 py-5 border-l-4 border-emerald-500">
                            ...
                            <div>
                                ...
                                <a
                                    ...
                                    title="Send email to Tumakuru branch"
