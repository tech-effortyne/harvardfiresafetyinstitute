...
export const metadata: Metadata = {
    title: PAGE_METADATA.branches.raichur.title,
    description: PAGE_METADATA.branches.raichur.description,
    keywords: PAGE_METADATA.branches.raichur.keywords,
    alternates: {
        canonical: "/branches/raichur",
    },
};
...
export default function RaichurBranchPage() {
    return (
        <>
            {/* 1. Hero Section */}
            <section className="bg-gradient-to-r from-[#7A1E2B] to-[#5a1620] py-12 md:py-20 relative overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        ...
                        alt="Harvard Institute Raichur Branch"
                        fill
                ...
                <div className="container-custom relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <p className="text-white/80 text-lg leading-relaxed">
                            Professional fire and safety training at City Talkies Road, Raichur.
            ...
            <section className="py-12 bg-gray-50">
                <div className="container-custom">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-sm text-[#2B2B2B]/60">Get in touch with our Raichur team</p>
                    </div>
                    <div className="max-w-2xl mx-auto bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        ...
                        <div className="flex items-start gap-4 px-6 py-5 border-l-4 border-[#7A1E2B]">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-[#2B2B2B]/70 leading-relaxed">
                                    Katakam Kristaiah Complex, 1st Floor,<br />
                        ...
                        <div className="flex items-start gap-4 px-6 py-5 border-l-4 border-[#F57C00]">
                            ...
                            <div>
                                ...
                                <a
                                    href="tel:6361955804"
                                    title="Call Raichur branch at 6361955804"
